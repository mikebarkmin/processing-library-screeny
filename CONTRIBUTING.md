...
1. Clone your new repository to your Eclipse workspace.
  ...
  * Select the `master` branch on the next screenyScreen, and click "Next >".
  * The default settings on the "Local Configuration" screenyScreen should work fine, click "Next >".
